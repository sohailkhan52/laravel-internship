                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                              ...
                              <div class="row mt-4">
                                  <div class="col-md-8 offset-md-4">        
                                      <a href="{{ route('google.login') }}" class="btn btn-danger d-flex align-items-center justify-content-center" style="width: 200px; margin: 0 auto;">
                                          <svg style="width: 20px; height: 20px; margin-right: 10px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
